...
export function AcademySection() {
  return (
    <section id="academy" className="py-32 relative bg-secondary">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background border border-border">
              ...
              <span className="text-sm font-medium text-foreground">AI Academy</span>
            </div>
            
            <h2 className="text-4xl sm:text-5xl font-bold text-foreground">
              Learn to Build & Sell
              <span className="block text-foreground">AI-Powered Courses</span>
            </h2>
          ...
          <div className="relative">
            <img 
              ...
              src="/lovable-uploads/fedd7044-7828-4934-99ba-e93e8cc0162c.jpg" 
            />
          </div>
        </div>
        ...
        <div className="space-y-8">
          <h3 className="text-3xl font-bold text-center text-foreground">What You'll Learn</h3>
          
          <div className="grid md:grid-cols-2 gap-6">
            {courseModules.map((module) => (
              <div 
                key={module.title} 
                className="group bg-background border border-border p-6 rounded-2xl hover:border-foreground/30 hover:shadow-lg transition-all duration-300 flex gap-6"
              >
                <div className="w-14 h-14 rounded-xl bg-secondary flex items-center justify-center flex-shrink-0 group-hover:bg-foreground transition-colors">
                  <module.icon className="h-7 w-7 text-foreground group-hover:text-background" />
                </div>
                <div>
        ...
        {/* CTA */}
        <div className="mt-20 text-center bg-background border border-border p-12 rounded-3xl">
          <Award className="h-16 w-16 text-foreground mx-auto mb-6" />
          <h3 className="text-3xl font-bold mb-4 text-foreground">Get Certified in AI</h3>
