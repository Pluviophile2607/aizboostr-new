    ...
    <section ref={sectionRef} id="video-ads-section" className="py-20 relative overflow-hidden bg-secondary">
      <div className="max-w-full mx-auto">
        ...
        <div className="relative group">
          {/* Navigation Buttons - positioned within section */}
          <Button
            variant="outline"
            size="icon"
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-background/90 backdrop-blur-sm border-border hover:bg-primary hover:text-primary-foreground shadow-lg w-12 h-12 rounded-full"
            onClick={scrollLeft}
          >
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-background/90 backdrop-blur-sm border-border hover:bg-primary hover:text-primary-foreground shadow-lg w-12 h-12 rounded-full"
            onClick={scrollRight}
          >
